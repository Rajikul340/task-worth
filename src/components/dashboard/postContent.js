...
import { useAddTaskMutation } from "../../features/task/addTaskApi";
  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col w-full max-w-xs'>
        ...
        <input type='text'  className="input input-bordered w-full max-w-xs"  id='position' {...register("position")} />
      </div>
      <div className='flex flex-col w-full max-w-xs'>
      ...
      <div className='flex flex-col w-full max-w-xs'>
        ...
        <input type='text'   className="input input-bordered w-full max-w-xs" id='experience' {...register("experience")} />
      </div>
      <div className='flex flex-col w-full max-w-xs'>
        <label className='mb-2 text-lg' htmlFor='workLevel'>
          Work Level
        </label>
        <input type='text'   className="input input-bordered w-full max-w-xs" id='workLevel' {...register("workLevel")} />
      </div>
      <div className='flex flex-col w-full max-w-xs'>
      ...
      <div className='flex flex-col w-full max-w-xs'>
        ...
        <input type='text'   className="input input-bordered w-full max-w-xs" id='salaryRange' {...register("salaryRange")} />
      </div>
      <div className='flex flex-col w-full'>
        <label className='mb-2 text-lg' htmlFor='location'>
          Location
        </label>
        <input type='text'   className="input input-bordered w-full max-w-xs" id='location' {...register("location")} />
      </div>
      ...
      <div className='flex flex-col w-full'>
        ...
        <textarea className="textarea textarea-bordered " rows={8} {...register("overview")} id='overview' />
      </div>
      <div className='flex flex-col w-full'>
